...
| **Insight** | The trust gap was diagnosed as a content problem — "we have no clients we may name". It is not. **Proof does not have to come from clients.** It can come from third parties, from work that is already public, and from the artefact the buyer is looking at |
